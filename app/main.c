...
/**
 * @file    main.c
 * @brief   MAX Firmware - Main Application Entry Point
 * @details This application demonstrates FreeRTOS with BLE capabilities
 *          for workout tracking on the MAX32655 platform.
 */
...
/* =| Static memory for FreeRTOS kernel objects |=========
 *
...
/* Static memory for the timer task (required if configUSE_TIMERS is 1) */
#if configUSE_TIMERS
 ...
 * Initializes the system and starts the FreeRTOS scheduler.
 *
 * =======================================================
 */
int main(void)
{
    ...
    /* Initialize application modules (workout tasks, etc.) */
    if (!App_Init())
    {
