...
#ifndef MAX_FIRMWARE_FREERTOSCONFIG_H
#define MAX_FIRMWARE_FREERTOSCONFIG_H
...
/* Enable static allocation (no malloc for FreeRTOS objects) */
...
#endif /* MAX_FIRMWARE_FREERTOSCONFIG_H */
